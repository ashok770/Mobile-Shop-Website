...
import { Bell, CreditCard, ListChecks } from "lucide-react";
...
const benefits = [
  ...
  {
    icon: ListChecks,
    description: "Manage order history and delivery tracking in one place.",
  },
  {
    icon: Bell,
    description: "Receive timely updates on every order.",
  },
];
        ...
        <div className="auth-grid">
          ...
          >
            ...
            <svg className="auth-illustration" viewBox="0 0 160 160" aria-hidden="true">
              <defs>
                <linearGradient id="register-shape" x1="0" y1="0" x2="1" y2="1">
                  <stop stopColor="#38bdf8" stopOpacity=".22" />
                  <stop offset="1" stopColor="#3b82f6" stopOpacity=".04" />
                </linearGradient>
              </defs>
              <path d="M115 13c22 8 35 29 29 51-5 21-25 29-39 45-14 15-24 40-45 37-22-3-34-28-30-49 3-18 25-23 40-38 15-16 23-53 45-46Z" fill="url(#register-shape)" />
