...
function Payment() {
  ...
  const submitOrder = async () => {
    ...
    try {
      // Use axiosInstance so the interceptor attaches Authorization: Bearer <token>
      ...
      <main className="checkout-page-shell">
        <div className="checkout-page-container">
          ...
          <section className="checkout-empty">
            ...
            <p>Add an item before proceeding to payment.</p>
          ...
          <section className="checkout-card checkout-payment">
            ...
            <div className="checkout-payment-options">
              {options.map(({ id, label, icon: Icon }) => (
                <label
                  className={`checkout-payment-option ${payment === id ? "selected" : ""}`}
                  key={id}
                >
                  <input
                    type="radio"
